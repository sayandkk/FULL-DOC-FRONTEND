...
export interface Inward {
    ...
    description?: string;
    receivedDate: string;
    files?: { id: string; fileNumber: string; subject: string; status: FileStatus }[];
    /** @deprecated use files[0] — kept for backward compat */
    file?: FileRecord;
    /** @deprecated use files[0]?.id — kept for backward compat */
    fileId?: string;
    createdBy?: User;
    createdAt: string;
}
